...
https://github.ubc.ca/MDS-2022-23/DSCI_521_lab4_sgerla01.git
...
https://spencergerlach.github.io/MDS_DSCI_521_lab4/
...
```{r question-4-code, echo = FALSE}
question <- 4
question
```

This code chuck uses the option called `echo=FALSE`, which hides the code but only shows the output.
...
```{r question-5-code, echo = FALSE, comment = "##q5"}
question5 <- 5
print("hello")
print(question5)

```
This code chunk has two options: the `echo = FALSE` option supresses the code (not the output), and the `comment = "##q5` changes the default string that appends the output.
...
1. HTML Link:  https://github.ubc.ca/MDS-2022-23/DSCI_521_lab4_sgerla01/blob/master/DSCI_521_lab4_newRmd.html

2. PDF Link:  https://github.ubc.ca/MDS-2022-23/DSCI_521_lab4_sgerla01/blob/master/DSCI_521_lab4_newRmd.pdf 
...
HTML: https://github.ubc.ca/MDS-2022-23/DSCI_521_lab4_sgerla01/blob/master/DSCI_521_lab4_newRmd_q8.html

Rmd: https://github.ubc.ca/MDS-2022-23/DSCI_521_lab4_sgerla01/blob/master/DSCI_521_lab4_newRmd_q8.Rmd 
...
https://github.ubc.ca/MDS-2022-23/DSCI_521_lab4_sgerla01/blob/master/DSCI_521_lab4_newRmd_q8.md

The file looks rendered well for GitHub, but the plot of the data is not shown. It also shows the information in the YAML header differently.
